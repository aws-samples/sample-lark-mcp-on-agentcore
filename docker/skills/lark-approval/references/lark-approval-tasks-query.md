...
# 按关键词搜索任务列表
lark_invoke(tool_name="lark_approval_tasks_query", args={params: {"topic":"1","keyword":"测试","page_size":10}})
...
# 表格格式输出，便于快速浏览
lark_invoke(tool_name="lark_approval_tasks_query", args={params: {"topic":"1"}, format: "table"})
```
