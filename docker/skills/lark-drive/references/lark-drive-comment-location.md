...
已知评论 ID 批量查询时，把 `need_relation` 放在 data 里：

```
lark_invoke(tool_name="lark_drive_file_comments_batch_query", args={params: {"file_token": "<doc_token>", "file_type": "docx"}, data: {"comment_ids": ["<comment_id>"], "need_relation": true}})
```
