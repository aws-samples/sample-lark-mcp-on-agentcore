...
```
# 获取目标的量化指标
lark_invoke(tool_name="lark_okr_objective_indicators_list", args={params: {"objective_id": "7000000000000000001"}})

# 指定用户 ID 类型
lark_invoke(tool_name="lark_okr_objective_indicators_list", args={params: {"objective_id": "7000000000000000001", "user_id_type": "user_id"}})
```
